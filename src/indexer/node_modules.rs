...
use super::{
    DTS_PROGRESS_INTERVAL, MAX_FILE_SIZE, NODE_MODULES_MAX_DEPTH, PARSE_CHUNK_SIZE, ParsedFile,
    build_thread_pool,
};
...
pub fn index_node_modules_dts(conn: &mut Connection, root: &Path, progress: bool) -> Result<usize> {
    ...
    for (pkg_dir, nm_prefix) in &pkg_map {
        ...
        builder
            ...
            .git_exclude(false)
            .follow_links(false)
            .max_depth(Some(NODE_MODULES_MAX_DEPTH))
            .filter_entry(|entry| {
        ...
        let parsed_files: Vec<ParsedFile> = pool.install(|| {
            chunk
                ...
                .filter_map(|(abs_path, rel_path)| {
                    ...
                    if progress && c.is_multiple_of(DTS_PROGRESS_INTERVAL) {
